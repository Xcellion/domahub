  ...
  profile_demo_tour = new Tour({
    ...
    steps: [
      //main welcome step - 0
      {
        ...
        content:
          "This demo will guide you through the various tools available to DomaHub users.",
      ...
      //dashboard traffic - 1
      {
        ...
        content:
          "This is your DomaHub dashboard. Here you can see relevant statistics and charts about the traffic on your domain names.",
        path: "/profile/dashboard",
      },
      ...
      //dashboard portfolio overview - 2
      {
        ...
        content:
          "This is your portfolio overview. Here you can see relevant information about your domain names at a glance.",
      ...
      //dashboard left menu - 3
      {
        element: ".left-menu",
        content:
          'This is the navigation menu. Click Next to go to the <span class="is-bold">My Listings</span> page.',
        placement: "right",
        path: "/profile/dashboard",
        next: 5,
      },
      ...
      //mylistings - 5
      {
        orphan: true,
        content:
          'This is the <span class="is-bold">My Listings</span> page--where you can edit related details or view offers for all of your existing domain name listings.',
      ...
      //mylistings domain name table - 6
      {
        ...
        content:
          "Try selecting a few listings using the checkboxes to the left of the domain names.",
        placement: "top",
        onShow: function () {
      ...
      //mylistings buttons - 7
      {
        ...
        content:
          "Use these buttons to edit, view offers for, verify ownership of, or delete, your listings. Let's try editing some active listings by pressing on <span class='is-bold'>Edit Details</span>.",
        placement: "bottom",
        onShow: function () {
          //select verified domains if none are selected
          if (window.location.pathname == "/profile/mylistings") {
      ...
      {
        content:
          "This is the <span class='is-bold'>listings editing page</span>. Where you can change the information, design, and related details of your listings.",
      ...
      //mylistings edit design listings - 9
      {
        ...
        content:
          "This is the <span class='is-bold'>design tab</span> where you can change the look and feel of your listing pages.",
        placement: "top",
        onShow: function () {
          //show design tab
          if (window.location.pathname == "/profile/mylistings") {
      ...
      //mylistings offer view - 10
      {
        ...
        content:
          "This is the <span class='is-bold'>offers tab</span> where you can view the various offers made for your domain names.",
        placement: "top",
        path: "/profile/mylistings",
        redirect: false,
        onShow: function () {
      ...
      //create listings - 11
      {
        orphan: true,
        content:
          "This is the <span class='is-bold'>Create Listings</span> page where you can manually or automatically create new listings for your domain names.",
      ...
      //create listings manual card - 11
      {
        ...
        path: "/listings/create",
        content:
          "Enter your domain names here to create your listings manually.",
      },
      ...
      //create listings connect a registrar - 11
      {
        orphan: true,
        content:
          "This is the <span class='is-bold'>Profile Settings</span> page. Here, you can edit your profile information, payment details, or view your total account earnings.",
      ...
      //finished tutorial
      {
        ...
        template:
          ...
          (user.username != "DomaHubDemo" ? "data-role='end'" : "") +
          "> \
                            <span class='icon is-small'> \
                              <i class='fal fa-thumbs-up'></i> \
                            </span> \
                            <span>" +
          (user.username != "DomaHubDemo"
            ? "That was awesome! Thanks."
            : "That was awesome! Sign me up.") +
          "</span> \
                          </a> \
                        </div> \
                        <div class='control is-expanded'> \
                          <button id='tour-end-button' class='button is-stylish is-fullwidth is-small is-danger is-outlined' " +
          (user.username != "DomaHubDemo"
            ? "data-role='restart'"
            : "data-role='end'") +
          "> \
        ...
        content:
          "If you have any further questions, please do not hesitate to <a href='/contact' class='is-primary is-underlined'>contact us</a>.",
        path: "/profile/dashboard",
      },
    ],
  });
